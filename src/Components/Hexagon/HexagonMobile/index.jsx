...
class HexagonMobile extends Component {
                ...
                <List style={{ color: 'white' }}>
                    ...
                    <ListItem style={{ display: 'inline-block' }}>
                        ...
                        {/* <Clear
                            style={{ float: 'right', fontSize: 32, color: 'white' }}
                            onClick={e => {
                                this.props.home ? this.navigate("power-product") :
                                this.toggleDrawer(false)
                            }}
                        /> */}
                    </ListItem>
    ...
    determineViewBox() {
        if (window.innerHeight <= 630) {
            return '53 -230 220 500'
        }
        return '62 -230 200 500'
    }
                            ...
                            <Hexagon s={0} q={2.1} r={0.7} fill='red' />
                                ...
                                <Hexagon
                                    ...
                                    onClick={e => this.props.history.push("world_of_yamaha")
                                        // this.props.home ?  null :
                                        // this.toggleDrawer(true, 'WORLD OF YAMAHA')
                                    }>
...
export default withRouter(HexagonMobile)
