                ...
                >
                    ...
                    {options.map((option, index) => {
                        ...
                        return <MenuItem
                            ...
                            value={option.id}
                        >
                            {option.formatted_discounted_price_including_vat ? <>{option.formatted_discounted_price_including_vat}</> : <></>}   {option.syspro_colour}
                            {/* {option.price ? <>{option.colour}</> : <></>} {option.variant} */}
                        </MenuItem>;
                    })}
                </Select>
...
export default withTheme(FormCustomSelect);